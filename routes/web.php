...
Route::get('/allarticles', [CompanyController::class, 'allarticles'])->name('companyArticles');
Route::get('/allarticles/{article}', [CompanyController::class, 'articleView'])->name('companyArticle.view');
